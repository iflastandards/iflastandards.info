    ...
    if (typeof d != "undefined") {
        ...
        for (i = 0, len = ownKeys.length; i < len; i++) {
            ...
            if (typeof property != "undefined" && blacklist.indexOf(property) == -1) {
                rows += '<tr class="bg-light text-dark">' + '<td id="detail_key_' + property + '">' + property + ':</td>' + '<td class="definition" id="detail_def_' + property + '">';
                switch(property) {
                    case '@id':
                    case 'broader':
                    case 'narrower':
        ...
        var table = dtable.DataTable({
            ...
            "columns": [
                ...
                },
                {
                    "class": "definition",
                    "render": function (data, type, row) {
                        var definition = makeLiteral(row.definition);
